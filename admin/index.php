    ...
    <div class="col-xl-4 mg-t-20 mg-xl-t-0">
      ...
      <div class="card widget-messages mg-t-20">
        ...
        <div class="list-group list-group-flush">
          <?php
          foreach (select_all("contact_us", "LIMIT 4") as $contact) :
          ?>
            <a href="" class="list-group-item list-group-item-action media">
              ...
              <div class="media-body">
                ...
                <p class="msg-summary"><?= $contact['message'] ?></p>
              </div>
            </a>
          <?php endforeach ?>
        </div>
        <div class="card-footer">
          <a href="mailbox.php" class="tx-12"><i class="fa fa-angle-down mg-r-3"></i> See All Messages</a>
        </div><!-- card-footer -->
      </div><!-- card -->
    </div><!-- col-3 -->
  </div><!-- row -->
